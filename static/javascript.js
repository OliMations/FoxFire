...
function categoryMenuOpen() {
    ...
    document.querySelector("#searchButtonHolder").style.transform = "translate(0, -30vh)" 
    window.addEventListener("transitionend", function hideSearchBar() {
        document.querySelector("#searchButtonHolder").style.display = "none"
...
function categoryMenuClose() {
    ...
    document.querySelector("#searchButtonHolder").style.display = ""
